...
{
    /// <summary>
    /// This is the original 1960 application made before many classes were migrated.
    /// </summary>
    internal class LegacyProgram
    {
...
/*
        private static NineteenSixtyGameEngine GetGameEngine(int seed = 0) 
        {
            ...
            var cardComponent = new CardComponent<Player, Card>(random, Manifest.GMTCards);
