...
public class Manifest
{
        ...
        public static readonly Dictionary<State, LocationData<State, Player, Region>> StateData = new Dictionary<State, LocationData<State, Player, Region>>()
        {
            {State.AK,  new LocationData<State, Player, Region>(State.AK,  Region.West, 3,  Player.Nixon,  0)},
            {State.AL,  new LocationData<State, Player, Region>(State.AL,  Region.South, 11,  Player.Nixon,  0)},
            {State.AR,  new LocationData<State, Player, Region>(State.AR,  Region.South, 8,  Player.Kennedy,  1)},
            {State.AZ,  new LocationData<State, Player, Region>(State.AZ,  Region.West, 4,  Player.Kennedy,  1)},
            {State.CA,  new LocationData<State, Player, Region>(State.CA,  Region.West, 32,  Player.Nixon,  1)},
            {State.CO,  new LocationData<State, Player, Region>(State.CO,  Region.West, 6,  Player.Nixon,  0)},
            {State.CT,  new LocationData<State, Player, Region>(State.CT,  Region.East, 8,  Player.Nixon,  1)},
            {State.DE,  new LocationData<State, Player, Region>(State.DE,  Region.East, 3,  Player.Kennedy,  0)},
            {State.FL,  new LocationData<State, Player, Region>(State.FL,  Region.South, 10,  Player.Kennedy,  0)},
            {State.GA,  new LocationData<State, Player, Region>(State.GA,  Region.South, 12,  Player.Nixon,  0)},
            {State.HI,  new LocationData<State, Player, Region>(State.HI,  Region.West, 3,  Player.Kennedy,  2)},
            {State.IA,  new LocationData<State, Player, Region>(State.IA,  Region.Midwest, 10,  Player.Nixon,  0)},
            {State.ID,  new LocationData<State, Player, Region>(State.ID,  Region.West, 4,  Player.Nixon,  1)},
            {State.IL,  new LocationData<State, Player, Region>(State.IL,  Region.Midwest, 27,  Player.Nixon,  0)},
            {State.IN,  new LocationData<State, Player, Region>(State.IN,  Region.Midwest, 13,  Player.Kennedy,  0)},
            {State.KS,  new LocationData<State, Player, Region>(State.KS,  Region.West, 8,  Player.Nixon,  1)},
            {State.KY,  new LocationData<State, Player, Region>(State.KY,  Region.Midwest, 10,  Player.Nixon,  2)},
            {State.LA,  new LocationData<State, Player, Region>(State.LA,  Region.South, 10,  Player.Nixon,  0)},
            {State.MA,  new LocationData<State, Player, Region>(State.MA,  Region.East, 16,  Player.Kennedy,  2)},
            {State.MD,  new LocationData<State, Player, Region>(State.MD,  Region.East, 9,  Player.Kennedy,  2)},
            {State.ME,  new LocationData<State, Player, Region>(State.ME,  Region.East, 5,  Player.Kennedy,  0)},
            {State.MI,  new LocationData<State, Player, Region>(State.MI,  Region.Midwest, 20,  Player.Nixon,  1)},
            {State.MN,  new LocationData<State, Player, Region>(State.MN,  Region.Midwest, 11,  Player.Kennedy,  0)},
            {State.MO,  new LocationData<State, Player, Region>(State.MO,  Region.Midwest, 13,  Player.Kennedy,  0)},
            {State.MS,  new LocationData<State, Player, Region>(State.MS,  Region.South, 8,  Player.Kennedy,  1)},
            {State.MT,  new LocationData<State, Player, Region>(State.MT,  Region.West, 4,  Player.Kennedy,  2)},
            {State.NC,  new LocationData<State, Player, Region>(State.NC,  Region.South, 14,  Player.Nixon ,  0)},
            {State.ND,  new LocationData<State, Player, Region>(State.ND,  Region.West, 4,  Player.Kennedy,  1)},
            {State.NE,  new LocationData<State, Player, Region>(State.NE,  Region.West, 6,  Player.Nixon,  1)},
            {State.NH,  new LocationData<State, Player, Region>(State.NH,  Region.East, 4,  Player.Nixon,  2)},
            {State.NJ,  new LocationData<State, Player, Region>(State.NJ,  Region.East, 16,  Player.Nixon,  0)},
            {State.NM,  new LocationData<State, Player, Region>(State.NM,  Region.West, 4,  Player.Kennedy,  0)},
            {State.NV,  new LocationData<State, Player, Region>(State.NV,  Region.West, 3,  Player.Kennedy,  0)},
            {State.NY,  new LocationData<State, Player, Region>(State.NY,  Region.East, 45,  Player.Kennedy,  0)},
            {State.OH,  new LocationData<State, Player, Region>(State.OH,  Region.Midwest, 25,  Player.Kennedy,  0)},
            {State.OK,  new LocationData<State, Player, Region>(State.OK,  Region.West, 8,  Player.Nixon,  1)},
            {State.OR,  new LocationData<State, Player, Region>(State.OR,  Region.West, 6,  Player.Nixon,  1)},
            {State.PA,  new LocationData<State, Player, Region>(State.PA,  Region.East, 32,  Player.Nixon,  0)},
            {State.RI,  new LocationData<State, Player, Region>(State.RI,  Region.East, 4,  Player.Kennedy,  0)},
            {State.SC,  new LocationData<State, Player, Region>(State.SC,  Region.South, 8,  Player.Kennedy,  2)},
            {State.SD,  new LocationData<State, Player, Region>(State.SD,  Region.West, 4,  Player.Kennedy,  1)},
            {State.TN,  new LocationData<State, Player, Region>(State.TN,  Region.South, 11,  Player.Nixon,  1)},
            {State.TX,  new LocationData<State, Player, Region>(State.TX,  Region.South, 24,  Player.Nixon,  0)},
            {State.UT,  new LocationData<State, Player, Region>(State.UT,  Region.West, 4,  Player.Kennedy,  0)},
            {State.VA,  new LocationData<State, Player, Region>(State.VA,  Region.South, 12,  Player.Nixon,  1)},
            {State.VT,  new LocationData<State, Player, Region>(State.VT,  Region.East, 3,  Player.Nixon,  0)},
            {State.WA,  new LocationData<State, Player, Region>(State.WA,  Region.West, 9,  Player.Nixon,  1)},
            {State.WI,  new LocationData<State, Player, Region>(State.WI,  Region.Midwest, 12,  Player.Nixon,  0)},
            {State.WV,  new LocationData<State, Player, Region>(State.WV,  Region.East, 8,  Player.Nixon,  0)},
            {State.WY,  new LocationData<State, Player, Region>(State.WY,  Region.West, 3,  Player.Kennedy,  0)},
        };
