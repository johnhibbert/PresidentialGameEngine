...
namespace PresidentialGameEngine.ClassLibrary.Manifests
{
    public class NineteenSixty
    {
        ...
        public static readonly Dictionary<State, Tilt<Player>> StateTilts = new()
        {
            ...
            { State.CO, new Tilt<Player>{Player = Player.Nixon, StartingSupport = 0 } },
            { State.CT, new Tilt<Player>{Player = Player.Kennedy, StartingSupport = 1 } },
            ...
            { State.LA, new Tilt<Player>{Player = Player.Nixon, StartingSupport = 2 } },
            ...
            { State.MS, new Tilt<Player>{Player = Player.Nixon, StartingSupport = 2 } },
            { State.MT, new Tilt<Player>{Player = Player.Nixon , StartingSupport = 0 } },
            { State.NC, new Tilt<Player>{Player = Player.Nixon, StartingSupport = 1 } },
            ...
            { State.SC, new Tilt<Player>{Player = Player.Nixon, StartingSupport = 1 } },
            ...
            { State.TX, new Tilt<Player>{Player = Player.Nixon, StartingSupport = 0 } },
            { State.UT, new Tilt<Player>{Player = Player.Nixon, StartingSupport = 0 } },
            ...
            { State.WI, new Tilt<Player>{Player = Player.Kennedy, StartingSupport = 1 } },
