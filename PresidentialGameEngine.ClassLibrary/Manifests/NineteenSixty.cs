...
namespace PresidentialGameEngine.ClassLibrary.Manifests
{
    public class NineteenSixty
    {
        public static readonly Dictionary<State, ILocationData<State, Player, Region>> StateData = new()
        {
            ...
            {State.AL,  new StateData(State.AL,  Region.South, 11,  Player.Nixon,  0)},
            {State.AR,  new StateData(State.AR,  Region.South, 8,  Player.Kennedy,  1)},
            {State.AZ,  new StateData(State.AZ,  Region.West, 4,  Player.Kennedy,  1)},
            {State.CA,  new StateData(State.CA,  Region.West, 32,  Player.Nixon,  1)},
            {State.CO,  new StateData(State.CO,  Region.West, 6,  Player.Nixon,  0)},
            {State.CT,  new StateData(State.CT,  Region.East, 8,  Player.Nixon,  1)},
            {State.DE,  new StateData(State.DE,  Region.East, 3,  Player.Kennedy,  0)},
            {State.FL,  new StateData(State.FL,  Region.South, 10,  Player.Kennedy,  0)},
            {State.GA,  new StateData(State.GA,  Region.South, 12,  Player.Nixon,  0)},
            {State.HI,  new StateData(State.HI,  Region.West, 3,  Player.Kennedy,  2)},
            {State.IA,  new StateData(State.IA,  Region.Midwest, 10,  Player.Nixon,  0)},
            {State.ID,  new StateData(State.ID,  Region.West, 4,  Player.Nixon,  1)},
            {State.IL,  new StateData(State.IL,  Region.Midwest, 27,  Player.Nixon,  0)},
            {State.IN,  new StateData(State.IN,  Region.Midwest, 13,  Player.Kennedy,  0)},
            {State.KS,  new StateData(State.KS,  Region.West, 8,  Player.Nixon,  1)},
            {State.KY,  new StateData(State.KY,  Region.Midwest, 10,  Player.Nixon,  2)},
            {State.LA,  new StateData(State.LA,  Region.South, 10,  Player.Nixon,  0)},
            {State.MA,  new StateData(State.MA,  Region.East, 16,  Player.Kennedy,  2)},
            {State.MD,  new StateData(State.MD,  Region.East, 9,  Player.Kennedy,  2)},
            {State.ME,  new StateData(State.ME,  Region.East, 5,  Player.Kennedy,  0)},
            {State.MI,  new StateData(State.MI,  Region.Midwest, 20,  Player.Nixon,  1)},
            {State.MN,  new StateData(State.MN,  Region.Midwest, 11,  Player.Kennedy,  0)},
            {State.MO,  new StateData(State.MO,  Region.Midwest, 13,  Player.Kennedy,  0)},
            {State.MS,  new StateData(State.MS,  Region.South, 8,  Player.Kennedy,  1)},
            {State.MT,  new StateData(State.MT,  Region.West, 4,  Player.Kennedy,  2)},
            {State.NC,  new StateData(State.NC,  Region.South, 14,  Player.Nixon ,  0)},
            {State.ND,  new StateData(State.ND,  Region.West, 4,  Player.Kennedy,  1)},
            {State.NE,  new StateData(State.NE,  Region.West, 6,  Player.Nixon,  1)},
            {State.NH,  new StateData(State.NH,  Region.East, 4,  Player.Nixon,  2)},
            {State.NJ,  new StateData(State.NJ,  Region.East, 16,  Player.Nixon,  0)},
            {State.NM,  new StateData(State.NM,  Region.West, 4,  Player.Kennedy,  0)},
            {State.NV,  new StateData(State.NV,  Region.West, 3,  Player.Kennedy,  0)},
            {State.NY,  new StateData(State.NY,  Region.East, 45,  Player.Kennedy,  0)},
            {State.OH,  new StateData(State.OH,  Region.Midwest, 25,  Player.Kennedy,  0)},
            {State.OK,  new StateData(State.OK,  Region.West, 8,  Player.Nixon,  1)},
            {State.OR,  new StateData(State.OR,  Region.West, 6,  Player.Nixon,  1)},
            {State.PA,  new StateData(State.PA,  Region.East, 32,  Player.Nixon,  0)},
            {State.RI,  new StateData(State.RI,  Region.East, 4,  Player.Kennedy,  0)},
            {State.SC,  new StateData(State.SC,  Region.South, 8,  Player.Kennedy,  2)},
            {State.SD,  new StateData(State.SD,  Region.West, 4,  Player.Kennedy,  1)},
            {State.TN,  new StateData(State.TN,  Region.South, 11,  Player.Nixon,  1)},
            {State.TX,  new StateData(State.TX,  Region.South, 24,  Player.Nixon,  0)},
            {State.UT,  new StateData(State.UT,  Region.West, 4,  Player.Kennedy,  0)},
            {State.VA,  new StateData(State.VA,  Region.South, 12,  Player.Nixon,  1)},
            {State.VT,  new StateData(State.VT,  Region.East, 3,  Player.Nixon,  0)},
            {State.WA,  new StateData(State.WA,  Region.West, 9,  Player.Nixon,  1)},
            {State.WI,  new StateData(State.WI,  Region.Midwest, 12,  Player.Nixon,  0)},
            {State.WV,  new StateData(State.WV,  Region.East, 8,  Player.Nixon,  0)},
            {State.WY,  new StateData(State.WY,  Region.West, 3,  Player.Kennedy,  0)},
        };
            ...
            {5, new Card()
                {
                    ...
                    Event = (engine, player, choices) =>
                    {
                        ...
                        var changes = new NEW_ChangeBattery<Player,Issue,State,Region>();
                        changes.MomentumChanges.Add(new NEW_AccumulationChange<Player>(player, NEW_ChangeDirection.Gain, 1));
